...
import { Download, Building2, CheckCircle, Send, Loader2 } from "lucide-react";
  ...
  const handleGHLSync = async () => {
    ...
    try {
      ...
      toast.success(data.message, {
        description: data.failed > 0 ? `${data.failed} leads failed to sync` : "All leads synced successfully"
      });
