...
const Pricing = () => {
  ...
  const plans = [
    ...
    },
    {
      ...
      ctaVariant: "outline" as const,
      isPaid: false,
      // Tier styling - purple-pink for Enterprise (premium feel)
      iconBg: "from-purple-500/20 to-fuchsia-400/20",
            ...
            {plans.map((plan, index) => {
              ...
              const cardStyles = plan.popular 
                ...
                : plan.name === "Enterprise" 
                  ? "border-fuchsia-500/30 hover:border-fuchsia-500/50 hover:shadow-lg hover:shadow-fuchsia-500/10" 
              ...
              return (
                ...
                >
                  ...
                  {plan.name === "Enterprise" && (
                    <div className="absolute -top-4 left-1/2 -translate-x-1/2">
                      <Badge className="bg-gradient-to-r from-purple-500 to-fuchsia-400 text-white px-4 py-1 shadow-lg shadow-fuchsia-500/30">
                        Premium
                      </Badge>
                    </div>
                  )}
                  ...
                  <CardHeader className="text-center pb-4">
                    ...
                    <CardTitle className={`text-2xl ${plan.name === "Pro" ? "text-cyan-400" : plan.name === "Enterprise" ? "text-fuchsia-400" : "text-foreground"}`} style={{ fontFamily: 'Orbitron, sans-serif' }}>{plan.name}</CardTitle>
                    <CardDescription className="text-muted-foreground">{plan.description}</CardDescription>
                  </CardHeader>
                  
                  <CardContent className="space-y-6">
                    <div className="text-center">
                      <span className={`text-5xl font-bold ${plan.name === "Pro" ? "text-cyan-400" : plan.name === "Enterprise" ? "text-fuchsia-400" : "text-foreground"}`} style={{ fontFamily: 'Orbitron, sans-serif' }}>
                        {plan.price}
                      </span>
                    ...
                    <Button 
                      className={`w-full ${
                        plan.name === "Pro" 
                            ...
                            : plan.name === "Enterprise"
                              ? "border-fuchsia-500/50 text-fuchsia-400 hover:bg-fuchsia-500/10 hover:border-fuchsia-400"
                            : ""
                      }`}
