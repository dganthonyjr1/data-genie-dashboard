...
const SourceCode = () => {
  ...
  const sourceCode = `import { serve } from "https://deno.land/std@0.168.0/http/server.ts";
        ...
        <Card className="bg-card border-border">
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                <CardTitle className="text-2xl">Scraper Source Code</CardTitle>
                <CardDescription>
                  Complete source code for the process-scrape edge function
                </CardDescription>
              </div>
          ...
          <CardContent>
            <ScrollArea className="h-[calc(100vh-240px)] w-full rounded-md border border-border">
